"""Migrate to PostgreSQL with model changes

Revision ID: 0376ff919e8b
Revises: 
Create Date: 2025-02-22 20:13:20.691009
...
def upgrade():    
    ...
    sa.Column('timestamp', sa.DateTime(), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['companies.login_id'], ),
    sa.PrimaryKeyConstraint('id')
    )
